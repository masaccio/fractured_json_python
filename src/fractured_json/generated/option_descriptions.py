...
FLAG_DESCRIPTIONS = {
    ...
    "max_inline_length": "Like max-total-line-length , this is used to limit how much gets put onto one line. But this one doesn't count indentation. You might use this instead of max-total-line-length if you want to be sure that similar structures at different depths are formatted the same.",
    ...
    "omit_trailing_whitespace": "If true, the generated JSON text won't have spaces at the ends of lines. If omit-trailing-whitespace is false and comma-padding is true, often lines will end in a space.",
